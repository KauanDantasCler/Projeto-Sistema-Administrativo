  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group/card flex flex-col gap-(--card-spacing) overflow-hidden text-sm text-card-foreground",

        "rounded-2xl bg-card shadow-sm border-none",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[.border-b]:border-foreground/5 [.border-b]:pb-(--card-spacing)",
